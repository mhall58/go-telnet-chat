...
const (
	...
	defaultPrompt          = ">> "
	defaultWelcomeMessage  = "\r\nWelcome to GO chat! Type '/help' for a list of commands. type '/exit' to quit\r\n"
	defaultExitMessage     = "\r\nGoodbye!\r\n"
)

type ShellHandler struct {
	muxtex       sync.RWMutex
	producers    map[string]telsh.Producer
	elseProducer telsh.Producer
...
func NewChatHandler() *ShellHandler {
	producers := map[string]telsh.Producer{}
...
func (telnetHandler *ShellHandler) Register(name string, producer telsh.Producer) error {
...
func (telnetHandler *ShellHandler) MustRegister(name string, producer telsh.Producer) *ShellHandler {
...
func (telnetHandler *ShellHandler) RegisterHandlerFunc(name string, handlerFunc telsh.HandlerFunc) error {

	produce := func(ctx telnet.Context, name string, args ...string) telsh.Handler {
		return telsh.PromoteHandlerFunc(handlerFunc, args...)
	}
...
func (telnetHandler *ShellHandler) MustRegisterHandlerFunc(name string, handlerFunc telsh.HandlerFunc) *ShellHandler {
...
func (telnetHandler *ShellHandler) RegisterElse(producer telsh.Producer) error {
...
func (telnetHandler *ShellHandler) MustRegisterElse(producer telsh.Producer) *ShellHandler {
